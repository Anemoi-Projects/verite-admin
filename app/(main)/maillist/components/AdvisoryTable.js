...
const AdvisoryTable = ({ selectedLanguage }) => {
      ...
      cell: ({ row }) =>
        row?.original?.picture ? (
          <img
            ...
            className="text-blue-600 underline w-[150px] h-[100px]"
          />
        ) : (
          "N/A"
        ),
  ...
  const getAllAdvisoryMembers = (token) => {
    let config = {
      ...
      url:
        `${process.env.apiURL}/api/v1/team/getMembers?type=advisoryTeam&lang=` +
        selectedLanguage,
  ...
  const deleteItem = () => {
    ...
    axios
      ...
      .then((response) => {
        ...
        toast.success("Advisory Member deleted successfully", {
            ...
            <div className="flex justify-between items-center mb-4 border-b-4 pb-2 border-[#140B49]">
              <div className="flex justify-center items-center gap-2">
                ...
                <Dialog.Title className="text-lg font-semibold text-black">
                  {teamFormState?.state?.toUpperCase()} Advisory Team Member
                </Dialog.Title>
              </div>
        ...
        <Dialog.Portal>
          ...
          >
            ...
            <Dialog.Description
              ...
              mb="4"
            >
              Are you sure you want to delete this Advisory Member?
            </Dialog.Description>
