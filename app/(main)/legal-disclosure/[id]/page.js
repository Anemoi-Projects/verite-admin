...
export default function Page() {
  ...
  const getSingleBlogData = useCallback(() => {
    ...
    let config = {
      method: "get",
      maxBodyLength: Infinity,
      url: `${process.env.apiURL}/api/v1/contents/getFooterPage?slug=/legal-disclosure&lang=${selectedLanguage}`,
      headers: {},
    };
  ...
  const onSubmit = async (data) => {
    ...
    axios
      .request(config)
      .then((response) => {
        toast.success("Legal Disclosure updated successfully", {
    ...
    <div className="bg-white text-black w-full">
      <header className="flex items-center justify-between px-6 py-4 border-b">
        <div className="flex gap-5">
          ...
          <h1 className="text-xl font-bold">Legal Disclosure Editor</h1>
        </div>
