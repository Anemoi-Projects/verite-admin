  ...
  return (
    <div className="bg-white text-black w-full">
      <header className="flex items-center justify-between px-6 py-4 border-b">
        <h1 className="text-xl font-bold">Add New Legal Disclosure</h1>
      </header>
        ...
        <Form {...form}>
          ...
          >
            <div className="w-1/2 mx-auto border rounded-md p-4 space-y-4 max-h-[720px] overflow-y-auto">
              <div>
                <label
                  className="flex items-center gap-2 text-sm leading-none font-medium select-none group-data-[disabled=true]:pointer-events-none group-data-[disabled=true]:opacity-50 peer-disabled:cursor-not-allowed peer-disabled:opacity-50 data-[error=true]:text-destructive mb-2"
                  htmlFor="lang"
                >
                  Language
                </label>
              ...
              {["heading", "slug", "description"].map((fieldName) => (
                <FormField
                  key={fieldName}
